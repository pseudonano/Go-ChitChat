...
func (thread *Thread) CreatedAtDate() string {
	return thread.CreatedAt.Format("Jan 2, 2006 at 2:59pm")
}
func (post *Post) CreatedAtDate() string {
	return post.CreatedAt.Format("Jan 2, 2006 at 2:59pm")
}
...
// Get user who started this thread
...
// Get the user who wrote te post
